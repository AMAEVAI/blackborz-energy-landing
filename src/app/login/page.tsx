      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="bg-[#0d0d0d] border border-[#1e1e1e] rounded-2xl p-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="text-xs text-[#666] font-medium uppercase tracking-wide block mb-1.5">
                Email
              </label>
              <input
                type="email"
                ...
                placeholder="manager@blackborz.ru"
                className="w-full px-3 py-2.5 bg-[#141414] border border-[#242424] rounded-xl text-sm text-white placeholder:text-[#444] focus:outline-none focus:border-[#c8ff00]/40 transition-colors"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-3 py-2.5 pr-10 bg-[#141414] border border-[#242424] rounded-xl text-sm text-white placeholder:text-[#444] focus:outline-none focus:border-[#c8ff00]/40 transition-colors"
                />
                <button
                  type="button"
            ...
            {error && (
              <div className="px-3 py-2.5 bg-red-500/10 border border-red-500/20 rounded-xl text-sm text-red-400">
                {error}
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-[#c8ff00] hover:bg-[#b8ef00] text-black font-bold rounded-xl text-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
